...
App.Notifications = {
  ...
  MESSAGES: [
    ...
    { title: '🌡️ Hőmérséklet-riport',       body: 'Meleg volt? Hűvös? A hőmérséklet befolyásolja a pollent!' },
    { title: '😮‍💨 Lélegezz... és rögzíts!', body: 'Egy mély levegő, egy gyors bejegyzés. Kész!' },
    { title: '🌬️ Szeles volt a nap?',       body: 'A szél pollen-bomba! Rögzítsd, hogy érezted magad.' },
    { title: '👀 Viszkető szemek?',         body: 'Ha igen, az AllergyTrack tudni akarja. Ha nem, szuper!' },
    { title: '🕵️ Allergia-nyomozó',         body: 'Minden napló egy nyom. Ma mi volt a gyanús?' },
    { title: '🌈 Ma jobb nap volt?',        body: 'Tünetmentes nap? → nyomd meg az értesítés gombját!' },
    { title: '🐝 Méhecske-alarm!',          body: 'A virágok virágoznak... az orrod tud erről valamit?' },
    { title: '☁️ Borult az ég?',            body: 'Felhős napokon kevesebb pollen van. Érezted?' },
    ...
    { title: '🎪 A pollen cirkusza!',        body: 'Főszereplő: te. Rögzítsd a mai tüneteket!' },
